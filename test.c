...
#define __pyx_kp_u_Hello_from_Python __pyx_string_tab[1]
#define __pyx_n_u_TEXT_TO_SAY __pyx_string_tab[2]
...
*/
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_TEXT_TO_SAY); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 4, __pyx_L1_error)
...
*/
  ...
  __Pyx_AddTraceback("test.say_hello_from_python", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
 ...
 * cdef public int say_hello_from_python() except -1:
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_TEXT_TO_SAY, __pyx_mstate_global->__pyx_kp_u_Hello_from_Python) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{18},{11},{18},{8},{10},{8},{5},{12},{10},{8}};
const char* const bytes = "?Hello from Python!TEXT_TO_SAYcline_in_traceback__main____module____name__print__qualname__setdefault__test__";
    PyObject *data = NULL;
